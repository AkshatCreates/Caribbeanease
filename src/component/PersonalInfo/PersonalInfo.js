        ...
        <div className="main-container">
            <div className="header">
                <div className="nav-bar">
                    ...
                    <div>
                        <button className="badge1"> Become a User</button>
                    </div>
                </div>
                <hr></hr>
            ...
            <div className="middle-container">
                ...
                <div className="side-bar">
                    ...
                    <div className="side-bar-info">
                        <div>
                            <b style={{ opacity: ".5" }}>Upload Profile Picture</b>
                            <div style={{ fontSize: "13px", paddingLeft: "49px", opacity: ".5" }}>Upload Information</div>
                        </div>
                    ...
                    <form >
                        <div className="form">
                            <div >
                                ...
                                <input className="form-input" type="text" placeholder="First Name" id="First Name" ></input>
                            </div>
                            <div >
                                <div><label for="Last Name">Last Name</label></div>
                                <input className="form-input" type="text" placeholder="Last Name" id="Last Name"></input>
                            </div>
                            <div >
                                <div><label for="Email">Email</label></div>
                                <input className="form-input" type="email" placeholder="Enter email" id="Email"></input>
                            </div>
                            <div>
                                <div><label for="Birthday">Birthday</label></div>
                                <input className="form-input" placeholder="DD/MM/YYYY" id="Birthday"></input>
                            </div>
                            <div>
                                <div><label for="Password">Password</label></div>
                                <input className="form-input" type="Password" placeholder="Enter Password" id="Password" ></input>
                            </div>
                            <div>
                                <div> <label for="Confirm Password">Confirm Password</label></div>
                                <input className="form-input" type="Password" placeholder="Enter Password" id="Confirm Password"></input>
                            </div>
                        </div>
